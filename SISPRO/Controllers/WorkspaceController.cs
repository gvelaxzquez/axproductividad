...
namespace AxProductividad.Controllers
{
    public class WorkspaceController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            Session["Controlador" + Session.SessionID] = "Workspace";
        ...
        [Route("w/{Id}")]
        public ActionResult W(string Id = "0")
        {
            ...
            if (Id != "0") {
                ...
                bool Acceso = cd_w.ValidaAccesoWorkSpace(Id, Usuario.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult CrearWorkspace(WorkSpaceModel W)
        {
            ...
            try
            {
                ...
                var Usuario = ((Models.Sesion)(Session["Usuario" + Session.SessionID])).Usuario;
                W.IdUCreo = Usuario.IdUsuario;

                List<ViewsModel> LstViews = new List<ViewsModel>();
                List<WorkSpaceModel> LstWorkspaces = new List<WorkSpaceModel>();

                CD_Workspace cd_ws = new  CD_Workspace();

                string g = cd_ws.GuardarWorkspace(W, Encripta.DesencriptaDatos(Usuario.ConexionEF));
                WorkSpaceModel ws = new WorkSpaceModel();
                ws = cd_ws.ConsultaWorkSpace(g, Encripta.DesencriptaDatos(Usuario.ConexionEF));
                LstViews = cd_ws.ConsultaVistasDisponibles(Encripta.DesencriptaDatos(Usuario.ConexionEF));

                //Actualizo la sesion
                LstWorkspaces = cd_ws.ConsultaWorkspaces(Usuario.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));
                var sesion = ((Models.Sesion)(Session["Usuario" + Session.SessionID]));
                sesion.Workspaces = LstWorkspaces;
                ...
                Resultado["WorkSpace"] = JsonConvert.SerializeObject(ws);
                Resultado["Views"] = JsonConvert.SerializeObject(LstViews);
        ...
        public ActionResult ConsultaWorkspace(string Id)
        {
            var Resultado = new JObject();
            try
            {
                ...
                w = cd_ws.ConsultaWorkSpace(Id, Encripta.DesencriptaDatos(Usuario.ConexionEF));
                LstViews = cd_ws.ConsultaVistasDisponibles(Encripta.DesencriptaDatos(Usuario.ConexionEF));


                Resultado["Exito"] = true;
                Resultado["WorkSpace"]  = JsonConvert.SerializeObject(w);
                Resultado["Views"] = JsonConvert.SerializeObject(LstViews);
                return Content(Resultado.ToString());
            }
            catch (Exception ex)
        ...
        public ActionResult ConsultaWorkspaceList()
        {
            var Resultado = new JObject();
            try
            {
                ...
                Lst = cd_ws.ConsultaWorkSpaceList(Usuario.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ConsultaWidgets()
        {
            var Resultado = new JObject();
            try
            {
                ...
                Lst = cd_ws.ConsultaWidgetsDisponibles(Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult EliminaWorkspace(long IdWorkSpace)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.EliminaWorkSpace(IdWorkSpace, Usuario.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ConsultaWorkspaceTab(long IdWorkSpaceTab)
        {
            var Resultado = new JObject();
            try
            {
                ...
                WorkSpaceTabsModel w = new WorkSpaceTabsModel();

                w = cd_ws.ConsultaWorkSpaceTab(IdWorkSpaceTab, Encripta.DesencriptaDatos(Usuario.ConexionEF));

                Resultado["Exito"] = true;
                Resultado["WorkSpaceTab"] = JsonConvert.SerializeObject(w);
                return Content(Resultado.ToString());
            }
            catch (Exception ex)
            {
        ...
        public ActionResult ConsultaArchivosWorkspaceTab(long IdWorkSpaceTab)
        {
            var Resultado = new JObject();
            try
            {
                ...
                Lst = cd_ws.ConsultaArchivos(IdWorkSpaceTab, Encripta.DesencriptaDatos(Usuario.ConexionEF));

                Resultado["Exito"] = true;
                Resultado["Files"] = JsonConvert.SerializeObject(Lst);
                return Content(Resultado.ToString());
            }
            catch (Exception ex)
            {
        ...
        public ActionResult ActualizaNombreWS(WorkSpaceModel ws)
        {
            var Resultado = new JObject();
            try
            {
                ...
                ws.IdUMod = Usuario.IdUsuario;
                bool resultado = cd_ws.ActualizaNombreWs(ws, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ActualizaNombreTab(WorkSpaceTabsModel ws)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool resultado = cd_ws.ActualizaNombreTab(ws, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult AgregaNuevoTab(WorkSpaceTabsModel wst)
        {
            var Resultado = new JObject();
            try
            {
                ...
                ws = cd_ws.AgregarTabWorkspace(wst ,Usuario.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));

                Resultado["Exito"] = true;
                Resultado["WorkSpaceTab"] = JsonConvert.SerializeObject(ws);
        ...
        public ActionResult ActualizarOrdenTabs(List<WorkSpaceTabsModel> Lst)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.ActualizarOrdenTabs(Lst, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult EliminaTab(long IdWorkSpaceTab)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.EliminarTab(IdWorkSpaceTab, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ActualizaAgrupadorTab(WorkSpaceTabsModel wst)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.ActualizarAgrupadorTab(wst, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ActualizaColumnasTab(WorkSpaceTabsModel wst)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.ActualizarColumnasTab(wst, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult ActualizaPanelWidgets(WorkSpaceTabsModel wst)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.ActualizarPanelWidgets(wst, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult CargaUsuarios()
        {
            ...
            try
            {
                ...
                Resultado["Exito"] = true;
                Resultado["Users"] = JsonConvert.SerializeObject(LstUsuarios);
                return Content(Resultado.ToString());
            }
            catch (Exception ex)
            {
        ...
        public ActionResult CargaUsuariosTodos()
        {
            var Resultado = new JObject();
            try
            {
                ...
                List<CatalogoGeneralModel> LstUsuarios = cd_CatGenral.ObtenerUsuariosActivos(Conexion);
        ...
        public ActionResult ConsultaUsuariosWS(long IdWorkSpace)
        {
            var Resultado = new JObject();
            try
            {
                ...
                List<WorkSpaceShareModel> LstUsuarios = cd_ws.ConsultaUsuariosWS(IdWorkSpace, Conexion);
        ...
        public ActionResult EliminaWorkSpaceShare(long IdWorkSpaceShare)
        {
            var Resultado = new JObject();
            try
            {
                ...
                bool Exito = cd_ws.EliminaWorkSpaceShare(IdWorkSpaceShare, Encripta.DesencriptaDatos(Usuario.ConexionEF));
        ...
        public ActionResult GuardaWorkSpaceShare(WorkSpaceShareModel ws)
        {
            var Resultado = new JObject();
            try
            {
                var Usuario = ((Models.Sesion)(Session["Usuario" + Session.SessionID])).Usuario;
                CD_Workspace cd_ws = new CD_Workspace();
                ws.IdUCreo = Usuario.IdUsuario;

                long Exito = cd_ws.GuardaWorkSpaceShare(ws, Encripta.DesencriptaDatos(Usuario.ConexionEF));

                CD_Usuario cd_u = new CD_Usuario();
                var User = cd_u.ConsultarUsuario(ws.IdUsuario, Encripta.DesencriptaDatos(Usuario.ConexionEF));
                var wk = cd_ws.ConsultaWorkSpaceId(ws.IdWorkSpace , Encripta.DesencriptaDatos(Usuario.ConexionEF));


                bool Correo = FuncionesGenerales.EnviarCorreoInitacionWorkSpace(User, wk, Encripta.DesencriptaDatos(Usuario.ConexionEF));



                Resultado["Exito"] = true;
                Resultado["IdWorkSpaceShare"] = Exito;
        ...
        public ActionResult ConsultaActividadesTablero(long IdWorkSpaceTab, FiltrosModel Filtros)
        {
            var resultado = new JObject();
            try
            {
        ...
        public ActionResult CargaEstados(WorkFlowModel wf)
        {
            ...
            try
            {
                ...
                List<WorkFlowModel> Lst = cd_w.ConsultaEstados(wf.IdProyecto, wf.IdActividadTipo,  Conexion);
   


                resultado["Exito"] = true;

                resultado["LstWorkflow"] = JsonConvert.SerializeObject(Lst);
        ...
        public ActionResult EliminarWorkFlow(long IdWorkFlow)
        {
            ...
            try
            {
                ...
                resultado["Exito"] = Respuesta;
                resultado["Mensaje"] = Respuesta == false ? "No se pudo eliminar, existen tareas relacionadas con este estado" : "";
        ...
        public ActionResult Grafica_SumByStatus(FiltrosModel Filtros) {
            var resultado = new JObject();
            try
            {
                if (!FuncionesGenerales.SesionActiva())
                ...
                CD_Graficas cd_g = new CD_Graficas();
                var Usuario = ((Models.Sesion)(Session["Usuario" + Session.SessionID])).Usuario;

                List<PieChartModel> Lst = new List<PieChartModel>();

                Lst = cd_g.Grafica_SumByStatus(Filtros, Encripta.DesencriptaDatos(Usuario.ConexionSP));

                resultado["Exito"] = true;
                resultado["Datos"] = JsonConvert.SerializeObject(Lst);
                return Content(resultado.ToString());
        ...
        public ActionResult GraficaPie(FiltrosModel Filtros, string group)
        {
            var resultado = new JObject();
            try
            {
                ...
                {
                    Lst = cd_g.Grafica_SumByAssigned(Filtros, Encripta.DesencriptaDatos(Usuario.ConexionSP));

                }
                else if (group == "owner") {
                    Lst = cd_g.Grafica_SumByOwner(Filtros, Encripta.DesencriptaDatos(Usuario.ConexionSP));
                }
        ...
        public ActionResult IndicadorSuma(FiltrosModel Filtros, string group)
        {
            var resultado = new JObject();
            try
            {
                ...
                Total = cd_g.IndicadorSuma(Filtros, group, Encripta.DesencriptaDatos(Usuario.ConexionSP));
        ...
        public ActionResult IndicadorConteo(FiltrosModel Filtros)
        {
            var resultado = new JObject();
            try
            {
                ...
                Total = cd_g.IndicadorConteo(Filtros, Encripta.DesencriptaDatos(Usuario.ConexionSP));
