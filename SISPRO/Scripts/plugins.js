            ...
            if($(".wizard").length > 0){
                ...
                $(".wizard").smartWizard({                        
                    ...
                    onLeaveStep: function (obj) {
                        ...
                        var container =  wizard.find(".stepContainer");
                        var tecla= obj.Type;
                       
                         var paso = obj.attr('rel');

                         //if (paso == 1) {
                         //    var Mensaje = ValidaCamposRequeridos(".ReqRequisiciones");
                         //    if (Mensaje.length != 0) {
                         ...
                         //    }
                         //    else {
                         //    $("#Paso2Val").addClass('ReqPaso2');
                         //    }
                         //}
                         //else if (paso == 2) {
                         //   var Mensaje = ValidaCamposRequeridos(".ReqPaso2");
                         //   if (Mensaje.length != 0) {
                         //        wizard.find(".stepContainer").removeAttr("style");
                         //        // validator.focusInvalid();                                
                         //        return false;
