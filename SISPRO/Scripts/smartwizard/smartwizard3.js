...
function SmartWizard(target, options) {
    ...
    this.buttons = {
          ...
          next: $('<a>' + options.labelNext + '</a>').attr("href", "#").addClass("btn btn-default pull-right buttonNext"),
        previous: $('<a>' + options.labelPrevious + '</a>').attr("href", "#").addClass("btn btn-default pull-left buttonPrevious"),
