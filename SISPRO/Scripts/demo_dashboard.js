$(function(){        
    ...
    Morris.Donut({
        ...
        data: [
            {label: "Urgentes", value: 350},
            {label: "No urgentes", value: 170},
        ],
        colors: ['#FF0000', '#19A014'],
        resize: true
    });
    ...
    Morris.Donut({
        ...
        data: [
             ...
             { label: "Procesadas", value: 210 },
              { label: "Vencidas", value: 20 },
            { label: "Aprobadas", value: 100 },
            { label: "Validadas", value: 50 },
        { label: "Enviadas a validación", value: 50 },
        { label: "Generadas", value: 90 }
        ],
        colors: ['#19A014', '#FF0000', '#BF0A95', '#4E7CF9', '#1A398F', '#32FCF9'],
        resize: true
    });
    /* Bar dashboard chart */
    /* Donut dashboard chart */
    Morris.Donut({
        ...
        data: [
            { label: "Compras", value: 260 },
            { label: "Sistemas", value: 150 },
            { label: "Producción", value: 110 }
        ],
