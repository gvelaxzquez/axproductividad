        ...
        Comentarios: {
            ...
            ComentarioTabla: (urlImg, cveU, nombre, fecha, comentario, tamaño) =>
                `<div class="comentario-tabla-container">
                     <div class="first">
                        <div class='center-cropper'><div class='tabla'><img src="${urlImg}" title="" alt="${cveU}" data-usuario="${IssueProyecto.Funciones.Comentarios.DataUsuario(nombre)}" data-url="${IssueProyecto.Funciones.Comentarios.DataUrl(urlImg)}" class="u-a-i" /></div></div>               
                     </div>
                     <div class="second">
