    ...
    },
    {
        ...
        "render": function (data, type, row) {
            if (data == "") {
                ...
                return `<img src="https://axsis.yitpro.com/Archivos/Fotos/${data}.jpg" class="img-dt" style="width: 35px; height: 35px" /><a class="btn btn-link"> ${row.AsignadoStr}</a>`
            }
            ...
            gantt.config.columns = [
                {
                    name: "avance", label: "", align: "center", width: 70, template: function (obj) {
                        ...
                        return `<img src="https://axsis.yitpro.com/Archivos/Fotos/${obj.avance}.jpg" title="${obj.asignadostr}" class="img-dt" style="width: 24px; height: 24px" />`;
        ...
        $.each(dsDatos, function (key, value) {
            ...
            if (tipo == "Pie") {
                ...
                var script = "<script>"
                    ...
                    + " feature: { "
                    + "            mark: { show: false },"
                    + "            magicType: { show: false, type: ['line', 'bar','pie'] , title:''},"
                    + "    saveAsImage: {"
                    + "        show: true, "
                    + "        title: 'Descargar'"
                    + "    }"
